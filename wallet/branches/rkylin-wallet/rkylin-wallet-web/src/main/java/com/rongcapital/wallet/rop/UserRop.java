...
public class UserRop {
    ...
    public static BankInfo cardDetail(UserInfoVo user, String cardNo) throws Exception {
        ...
        logger.debug("UserRop.cardDetail-rop入参:" + JsonUtil.bean2JsonStr(request));
        WheatfieldCheckstandCardbinQueryResponse response = ROPClientUtils.execute(ropClient, request);
        logger.debug("UserRop.cardDetail-rop返回:" + JsonUtil.bean2JsonStr(response));
     ...
     * @since 2016年8月30日
     */
    public static ResultVo identityAuth(UserInfoVo user) throws ApiException, ParseException {
