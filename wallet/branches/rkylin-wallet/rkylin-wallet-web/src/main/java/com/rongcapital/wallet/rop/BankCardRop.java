...
public class BankCardRop {
    ...
    public static ResultVo cardBind(UserInfoVo user, CardInfoVo card) throws Exception {
        ...
        request.setCertificatetype(null != user.getIdCardType() ? user.getIdCardType()
                : String.valueOf(CardConstants.CARD_TYPE_CERTIFICATE_VALIDATE)); // 开户证件类型0：身份证,1: 户口簿，2：护照
