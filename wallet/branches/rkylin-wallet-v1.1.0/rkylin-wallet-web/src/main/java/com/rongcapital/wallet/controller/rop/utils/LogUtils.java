...
public class LogUtils {
    ...
    public static void debug(Map<String, String[]> requestParams, Date startTime, Date endTime, Response response,
            String ip) {
     ...
     * @param ip
     */
    public static void info(Map<String, String[]> requestParams, Date startTime, Date endTime, Response response,
            String ip) {
    ...
    public static void warn(Map<String, String[]> requestParams, Date startTime, Date endTime, Response response,
            String ip) {
        logger.warn(getLogMessage(requestParams, startTime, endTime, response, ip));
    }

    public static void error(Map<String, String[]> requestParams, Date startTime, Date endTime, Response response,
            String ip) {
        logger.error(getLogMessage(requestParams, startTime, endTime, response, ip));
    }

    public static void fatal(Map<String, String[]> requestParams, Date startTime, Date endTime, Response response,
            String ip) {
        logger.error(getLogMessage(requestParams, startTime, endTime, response, ip));
    }
     ...
     * @return
     */
    private static String getLogMessage(Map<String, String[]> requestParams, Date startTime, Date endTime,
            Response response, String ip) {
