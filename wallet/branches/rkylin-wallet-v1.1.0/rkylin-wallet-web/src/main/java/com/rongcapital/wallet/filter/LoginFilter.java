...
public class LoginFilter extends HttpServlet implements Filter {
    ...
    private final static String LOGIN_PATH_LOGINNAME_EXISTS = "/user/loginNameExists.do";
    ...
    private final static String SMS_SEND_SET_TIME = "/sms/sendSMSSetTime.do"; // 发短信
    ...
    private final static String LOGIN_REGISTER_NEW = "/user/registerNew.do";
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        if (null != conPath && conPath.length() > 0) {
            ...
            mapUrl.put(conPath + LOGIN_PATH_LOGINNAME_EXISTS, "");
            mapUrl.put(conPath + IDENTITY_AUTH, "");
            mapUrl.put(conPath + SMS_SEND, "");
            mapUrl.put(conPath + SMS_SEND_SET_TIME, "");
            ...
            mapUrl.put(conPath + LOGIN_REGISTER_NEW, "");
        } else {
            ...
            mapUrl.put(LOGIN_PATH_LOGINNAME_EXISTS, "");
            mapUrl.put(IDENTITY_AUTH, "");
            mapUrl.put(SMS_SEND, "");
            mapUrl.put(SMS_SEND_SET_TIME, "");
