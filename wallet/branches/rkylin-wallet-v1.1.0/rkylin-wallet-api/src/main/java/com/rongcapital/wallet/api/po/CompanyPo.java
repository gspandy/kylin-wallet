...
public class CompanyPo implements Serializable {
    ...
    private String comBankBranchName;  //企业开户行名称
    private String comBankNum;  //企业银行卡号

    private String corporateBankBranchName; //法人开户行名称
    private String corporateBankNum; //法人银行卡号
    ...
    public void setBindBankNum(String bindBankNum) {
        this.bindBankNum = bindBankNum;
    }
    ...
    public void setBindRealName(String bindRealName) {
    ...
    public String getComBankNum() {
        return comBankNum;
    }

    public void setComBankNum(String comBankNum) {
        this.comBankNum = comBankNum;
    }

    public String getCorporateBankBranchName() {
        return corporateBankBranchName;
    }

    public void setCorporateBankBranchName(String corporateBankBranchName) {
        this.corporateBankBranchName = corporateBankBranchName;
    }

    public String getCorporateBankNum() {
        return corporateBankNum;
    }

    public void setCorporateBankNum(String corporateBankNum) {
        this.corporateBankNum = corporateBankNum;
    }
